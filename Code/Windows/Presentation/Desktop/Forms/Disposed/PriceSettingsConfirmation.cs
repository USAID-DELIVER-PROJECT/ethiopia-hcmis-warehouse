...
namespace HCMIS.Desktop.Forms.WorkFlow
{
    ...
    [FormIdentifier("PR-CO-MA-CN-Center","Price Confirmation","")]
    public partial class PriceSettingsConfirmation : DevExpress.XtraEditors.XtraForm
    {
        ...
        public PriceSettingsConfirmation()
        {
            InitializeComponent();
        }
