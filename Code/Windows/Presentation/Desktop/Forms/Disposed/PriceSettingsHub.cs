...
namespace HCMIS.Desktop.Forms.WorkFlow
{
  ...
  [FormIdentifier("CM-CM-FV-FR", "Moving Average", "")]
    public partial class PriceSettingsHub : DevExpress.XtraEditors.XtraForm
    {
        
        bool isConfirmation;
        ReceivedSummary rs = new ReceivedSummary();
        CostElement costElement;
        public PriceSettingsHub()
        {
            InitializeComponent();
        }
        ...
        {
            rs.Margin = Convert.ToDouble(txtMargin.Text);
        }
          ...
          private void LoadDecimalFormatings()
        {
            ...
            colSellingPrice.DisplayFormat.FormatString = sharps;
            colSellingPrice.SummaryItem.DisplayFormat = sharps;
        ...
        private void gridMainLeft_MouseClick(object sender, MouseEventArgs e)
      {
        ...
        private void btnHistory_Click(object sender, EventArgs e)
        {
            ...
            int AccountID = Convert.ToInt32(lkAccount.EditValue);
            int unitID = Convert.ToInt32(dr["UnitID"]);


            WeightedAverageHistory form = new WeightedAverageHistory(itemID, AccountID, ManufacturerID, unitID);

            form.ShowDialog(this);
        }

        private void btnProrate_Click(object sender, EventArgs e)
        {
           
            rs.Prorate(Convert.ToDouble(txtAdditional.EditValue));
            txtAverageCost.EditValue = rs.NewUnitCost;
        }
