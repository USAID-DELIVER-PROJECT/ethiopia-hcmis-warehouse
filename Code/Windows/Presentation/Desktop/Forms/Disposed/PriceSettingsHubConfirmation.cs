...
{
    [Obsolete("Replace by PriceOverideConfirmation Form")]
     [FormIdentifier("PR-CO-MA-CN", "Price Confirmation", "")]
    public partial class PriceSettingsHubConfirmation : DevExpress.XtraEditors.XtraForm
    {
        
        bool isConfirmation;
        ReceivedSummary rs = new ReceivedSummary();

        public PriceSettingsHubConfirmation()
        {
            InitializeComponent();
        }
