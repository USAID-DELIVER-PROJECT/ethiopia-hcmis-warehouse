...
namespace HCMIS.Desktop.Helpers
{
    ...
    //    {
    //        return changeToWords(numb.ToString("####.00"), true);
    //    }
    ...
    //                    andStr = (isCurrency) ? ("Birr and ") : ("point");// just to separate whole numbers from points/cents
    ...
    public class FormattingHelpers
    {
        ...
        {
            int noOfDigits = BLL.Settings.NoOfDigitsAfterTheDecimalPoint;
            string sharps = "#,###,###,##0.";
        ...
        public static DataView  GetCurrencyList()
        {
            ...
            currency.Columns.Add("ID",typeof(int));
