...
{    
    public partial class STVonA4 : DevExpress.XtraReports.UI.XtraReport
    {
        public int _orderID;
        ...
        public STVonA4(int orderID, bool includeInsurance, string userFullName)
        {
            InitializeComponent();
        ...
        private void xrInsuranceValue_SummaryCalculated(object sender, DevExpress.XtraReports.UI.TextFormatEventArgs e)
        {
            try
            {
                ...
                {
                    insuranceValue = 0;
                    totalWithoutInsurance = Convert.ToDouble(xrTotalWithoutInsurance.Text);
                    e.Text = " - ";
