...
namespace HCMIS.Concrete.Repository
{
    ...
    public partial class FakeRepositoryFactory
    {
    		...
    		private IRepository<Department> _Departments = null;
    
    		public IRepository<Department> Departments {
    			get{
    				if(_Departments == null){
    					_Departments = new FakeRepository<Department>();
    				}
    				return _Departments;
    			}
    		}
    		...
    		private IRepository<FinanceLog> _FinanceLogs = null;
    
    		public IRepository<FinanceLog> FinanceLogs {
    			get{
    				if(_FinanceLogs == null){
    					_FinanceLogs = new FakeRepository<FinanceLog>();
    				}
    				return _FinanceLogs;
    			}
    		}
    		...
    		private IRepository<Group> _Groups = null;
    		...
    		private IRepository<GroupPermission> _GroupPermissions = null;
    
    		public IRepository<GroupPermission> GroupPermissions {
    			get{
    				if(_GroupPermissions == null){
    					_GroupPermissions = new FakeRepository<GroupPermission>();
    				}
    		...
    		private IRepository<Type> _Types = null;
    
    		public IRepository<Type> Types {
    			get{
    				if(_Types == null){
    					_Types = new FakeRepository<Type>();
    				}
    				return _Types;
    			}
    		}
