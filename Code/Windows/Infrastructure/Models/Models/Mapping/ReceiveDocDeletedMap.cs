...
{
    public class ReceiveDocDeletedMap : EntityTypeConfiguration<ReceiveDocDeleted>
    {
        public ReceiveDocDeletedMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("ReceiveDocDeleted");
            ...
            this.HasOptional(t => t.User)
                .WithMany(t => t.ReceiveDocDeleteds)
