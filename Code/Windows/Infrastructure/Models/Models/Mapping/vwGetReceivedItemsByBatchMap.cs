...
{
    public class vwGetReceivedItemsByBatchMap : EntityTypeConfiguration<vwGetReceivedItemsByBatch>
    {
        public vwGetReceivedItemsByBatchMap()
        {
            // Primary Key
            this.HasKey(t => new { t.UnitID, t.ID, t.ReceiveID });
            ...
            this.ToTable("vwGetReceivedItemsByBatch");
