...
namespace DAL
{
	public abstract class _Cluster : SqlClientEntity
	{
		public _Cluster()
		{
			this.QuerySource = "Cluster";
			this.MappingName = "Cluster";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ClusterLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ClusterLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Cluster.PropertyNames.ID;
					ht[Name] = _Cluster.PropertyNames.Name;
					ht[Description] = _Cluster.PropertyNames.Description;
					ht[IsActive] = _Cluster.PropertyNames.IsActive;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Cluster.ColumnNames.ID;
					ht[Name] = _Cluster.ColumnNames.Name;
					ht[Description] = _Cluster.ColumnNames.Description;
					ht[IsActive] = _Cluster.ColumnNames.IsActive;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ClusterInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ClusterUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ClusterDelete]";
