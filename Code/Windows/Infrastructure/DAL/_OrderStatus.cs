...
namespace DAL
{
	public abstract class _OrderStatus : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter OrderStatusCode
			{
				get
				{
					return new SqlParameter("@OrderStatusCode", SqlDbType.NVarChar, 5);
				}
			}
		...
		{  
            ...
            public const string OrderStatusCode = "OrderStatusCode";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[IsActive] = _OrderStatus.PropertyNames.IsActive;
					ht[Rowguid] = _OrderStatus.PropertyNames.Rowguid;
					ht[CreatedDate] = _OrderStatus.PropertyNames.CreatedDate;
					ht[ModifiedDate] = _OrderStatus.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _OrderStatus.PropertyNames.ModifiedBy;
					ht[OrderStatusCode] = _OrderStatus.PropertyNames.OrderStatusCode;
					ht[SN] = _OrderStatus.PropertyNames.SN;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[IsActive] = _OrderStatus.ColumnNames.IsActive;
					ht[Rowguid] = _OrderStatus.ColumnNames.Rowguid;
					ht[CreatedDate] = _OrderStatus.ColumnNames.CreatedDate;
					ht[ModifiedDate] = _OrderStatus.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _OrderStatus.ColumnNames.ModifiedBy;
					ht[OrderStatusCode] = _OrderStatus.ColumnNames.OrderStatusCode;
					ht[SN] = _OrderStatus.ColumnNames.SN;
		...
		{  
            ...
            public const string OrderStatusCode = "s_OrderStatusCode";
		...
		public virtual string OrderStatusCode
	    {
			get
			{
			   return base.Getstring(ColumnNames.OrderStatusCode);
			}
			set
	        {
				base.Setstring(ColumnNames.OrderStatusCode, value);
			}
		}
		...
		public virtual string s_OrderStatusCode
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.OrderStatusCode) ? string.Empty : base.GetstringAsString(ColumnNames.OrderStatusCode);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.OrderStatusCode);
				else
					this.OrderStatusCode = base.SetstringAsString(ColumnNames.OrderStatusCode, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter OrderStatusCode
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.OrderStatusCode, Parameters.OrderStatusCode);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter OrderStatusCode
		    {
				get
		        {
					if(_OrderStatusCode_W == null)
	        	    {
						_OrderStatusCode_W = TearOff.OrderStatusCode;
					}
					return _OrderStatusCode_W;
				}
			}
			...
			private WhereParameter _OrderStatusCode_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter OrderStatusCode
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.OrderStatusCode, Parameters.OrderStatusCode);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _OrderStatusCode_W = null;
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.OrderStatusCode);
			p.SourceColumn = ColumnNames.OrderStatusCode;
			p.SourceVersion = DataRowVersion.Current;
