...
namespace DAL
{
	public abstract class _SoftwareSettings : SqlClientEntity
	{
		public _SoftwareSettings()
		{
			this.QuerySource = "SoftwareSettings";
			this.MappingName = "SoftwareSettings";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SoftwareSettingsLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SoftwareSettingsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SoftwareSettings.PropertyNames.ID;
					ht[Name] = _SoftwareSettings.PropertyNames.Name;
					ht[Value] = _SoftwareSettings.PropertyNames.Value;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SoftwareSettings.ColumnNames.ID;
					ht[Name] = _SoftwareSettings.ColumnNames.Name;
					ht[Value] = _SoftwareSettings.ColumnNames.Value;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SoftwareSettingsInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SoftwareSettingsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SoftwareSettingsDelete]";
