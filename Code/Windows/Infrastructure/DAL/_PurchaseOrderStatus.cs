...
namespace DAL
{
	public abstract class _PurchaseOrderStatus : SqlClientEntity
	{
		public _PurchaseOrderStatus()
		{
			this.QuerySource = "PurchaseOrderStatus";
            this.MappingName = "PurchaseOrderStatus";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PurchaseOrderStatusLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int PurchaseOrderStatusID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.PurchaseOrderStatusID, PurchaseOrderStatusID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PurchaseOrderStatusLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter PurchaseOrderStatusCode
			{
				get
				{
					return new SqlParameter("@PurchaseOrderStatusCode", SqlDbType.NVarChar, 5);
				}
			}
		...
		{  
            ...
            public const string PurchaseOrderStatusCode = "PurchaseOrderStatusCode";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PurchaseOrderStatusID] = _PurchaseOrderStatus.PropertyNames.PurchaseOrderStatusID;
					ht[Name] = _PurchaseOrderStatus.PropertyNames.Name;
					ht[Description] = _PurchaseOrderStatus.PropertyNames.Description;
					ht[IsActive] = _PurchaseOrderStatus.PropertyNames.IsActive;
					ht[PurchaseOrderStatusCode] = _PurchaseOrderStatus.PropertyNames.PurchaseOrderStatusCode;
					ht[Rowguid] = _PurchaseOrderStatus.PropertyNames.Rowguid;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PurchaseOrderStatusID] = _PurchaseOrderStatus.ColumnNames.PurchaseOrderStatusID;
					ht[Name] = _PurchaseOrderStatus.ColumnNames.Name;
					ht[Description] = _PurchaseOrderStatus.ColumnNames.Description;
					ht[IsActive] = _PurchaseOrderStatus.ColumnNames.IsActive;
					ht[PurchaseOrderStatusCode] = _PurchaseOrderStatus.ColumnNames.PurchaseOrderStatusCode;
					ht[Rowguid] = _PurchaseOrderStatus.ColumnNames.Rowguid;
		...
		{  
            ...
            public const string PurchaseOrderStatusCode = "s_PurchaseOrderStatusCode";
		...
		public virtual string PurchaseOrderStatusCode
	    {
			get
	        {
				return base.Getstring(ColumnNames.PurchaseOrderStatusCode);
			}
			set
	        {
				base.Setstring(ColumnNames.PurchaseOrderStatusCode, value);
			}
		}
		...
		public virtual string s_PurchaseOrderStatusCode
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.PurchaseOrderStatusCode) ? string.Empty : base.GetstringAsString(ColumnNames.PurchaseOrderStatusCode);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.PurchaseOrderStatusCode);
				else
					this.PurchaseOrderStatusCode = base.SetstringAsString(ColumnNames.PurchaseOrderStatusCode, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter PurchaseOrderStatusCode
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.PurchaseOrderStatusCode, Parameters.PurchaseOrderStatusCode);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter PurchaseOrderStatusCode
		    {
				get
		        {
					if(_PurchaseOrderStatusCode_W == null)
	        	    {
						_PurchaseOrderStatusCode_W = TearOff.PurchaseOrderStatusCode;
					}
					return _PurchaseOrderStatusCode_W;
				}
			}
			...
			private WhereParameter _PurchaseOrderStatusCode_W = null;
			...
			public void WhereClauseReset()
			{
				...
				_Description_W = null;
				_IsActive_W = null;
				_PurchaseOrderStatusCode_W = null;
				_Rowguid_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter PurchaseOrderStatusCode
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.PurchaseOrderStatusCode, Parameters.PurchaseOrderStatusCode);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _PurchaseOrderStatusCode_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PurchaseOrderStatusInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.PurchaseOrderStatusID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PurchaseOrderStatusUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PurchaseOrderStatusDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.PurchaseOrderStatusCode);
			p.SourceColumn = ColumnNames.PurchaseOrderStatusCode;
			p.SourceVersion = DataRowVersion.Current;
