...
namespace DAL
{
	public abstract class _ItemCategory : SqlClientEntity
	{
		public _ItemCategory()
		{
			this.QuerySource = "ItemCategory";
			this.MappingName = "ItemCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemCategoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemCategoryLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemCategory.PropertyNames.ID;
					ht[SubCategoryID] = _ItemCategory.PropertyNames.SubCategoryID;
					ht[ItemId] = _ItemCategory.PropertyNames.ItemId;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemCategory.ColumnNames.ID;
					ht[SubCategoryID] = _ItemCategory.ColumnNames.SubCategoryID;
					ht[ItemId] = _ItemCategory.ColumnNames.ItemId;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemCategoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemCategoryDelete]";
