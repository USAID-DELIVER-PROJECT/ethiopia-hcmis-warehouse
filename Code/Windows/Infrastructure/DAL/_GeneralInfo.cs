...
namespace DAL
{
	public abstract class _GeneralInfo : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter FacilityGuid
			{
				get
				{
					return new SqlParameter("@FacilityGuid", SqlDbType.UniqueIdentifier, 0);
				}
			}
			
			public static SqlParameter Image
			{
				get
				{
					return new SqlParameter("@Image", SqlDbType.Image, 2147483647);
				}
			}
		...
		{  
            ...
            public const string FacilityGuid = "FacilityGuid";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[FacilityGuid] = _GeneralInfo.PropertyNames.FacilityGuid;
					ht[Image] = _GeneralInfo.PropertyNames.Image;
					ht[InstitutionITypeID] = _GeneralInfo.PropertyNames.InstitutionITypeID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[FacilityGuid] = _GeneralInfo.ColumnNames.FacilityGuid;
					ht[Image] = _GeneralInfo.ColumnNames.Image;
					ht[InstitutionITypeID] = _GeneralInfo.ColumnNames.InstitutionITypeID;
		...
		{  
            ...
            public const string FacilityGuid = "s_FacilityGuid";
		...
		public virtual Guid FacilityGuid
	    {
			get
	        {
				return base.GetGuid(ColumnNames.FacilityGuid);
			}
			set
	        {
				base.SetGuid(ColumnNames.FacilityGuid, value);
			}
		}
		...
		public virtual byte[] Image
	    {
			get
	        {
				return base.GetByteArray(ColumnNames.Image);
			}
			set
	        {
				base.SetByteArray(ColumnNames.Image, value);
			}
		}
		...
		public virtual string s_FacilityGuid
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.FacilityGuid) ? string.Empty : base.GetGuidAsString(ColumnNames.FacilityGuid);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.FacilityGuid);
				else
					this.FacilityGuid = base.SetGuidAsString(ColumnNames.FacilityGuid, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter FacilityGuid
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.FacilityGuid, Parameters.FacilityGuid);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
				...
				public WhereParameter Image
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Image, Parameters.Image);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter FacilityGuid
		    {
				get
		        {
					if(_FacilityGuid_W == null)
	        	    {
						_FacilityGuid_W = TearOff.FacilityGuid;
					}
					return _FacilityGuid_W;
				}
			}
			...
			private WhereParameter _FacilityGuid_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter FacilityGuid
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.FacilityGuid, Parameters.FacilityGuid);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
				...
				public AggregateParameter Image
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Image, Parameters.Image);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _FacilityGuid_W = null;
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.FacilityGuid);
			p.SourceColumn = ColumnNames.FacilityGuid;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Image);
			p.SourceColumn = ColumnNames.Image;
			p.SourceVersion = DataRowVersion.Current;
