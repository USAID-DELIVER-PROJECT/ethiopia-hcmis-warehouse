...
namespace DAL
{
	public abstract class _SubAccount : SqlClientEntity
	{
		public _SubAccount()
		{
			this.QuerySource = "SubAccount";
			this.MappingName = "SubAccount";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SubAccountLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SubAccountLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SubAccount.PropertyNames.ID;
					ht[Name] = _SubAccount.PropertyNames.Name;
					ht[Description] = _SubAccount.PropertyNames.Description;
					ht[AccountID] = _SubAccount.PropertyNames.AccountID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SubAccount.ColumnNames.ID;
					ht[Name] = _SubAccount.ColumnNames.Name;
					ht[Description] = _SubAccount.ColumnNames.Description;
					ht[AccountID] = _SubAccount.ColumnNames.AccountID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubAccountInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubAccountUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubAccountDelete]";
